...
server {
	...
	#access_log  /data/logs/nginx/mydomain_access.log  main buffer=16k;
	#error_log  /data/logs/nginx/mydomain_error.log  warn;
}
EOF
...
vhostdir="/data/www/htdocs/"$domain
if [ ! -s $vhostdir ]; then
